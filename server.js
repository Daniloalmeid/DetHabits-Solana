...
// Substitua pelo endereço real do token DET
const TOKEN_PROGRAM_ID = new PublicKey('/* Insira o endereço do token DET aqui */');
        ...
        try {
            ...
            const transaction = new Transaction().add(
                createAssociatedTokenAccountInstruction(
                    centralWalletKeypair.publicKey, // Pagador da taxa
